...
2. **The author is the user, not Claude.** No `Co-Authored-By: Claude`, no "Generated with Claude Code" footer, no Claude attribution anywhere in the message or body.
...
- Any "Generated with" / "Co-Authored-By: Claude" line
